...
Hardware changes are tested on pull request [in CI](https://github.com/empriselab/mote/blob/main/.github/workflows/hardware-check.yaml).
Manufacturing files are released on any tag to `mote` matching the pattern `mote-hardware-vX.X.X`.
