...
ECAD files are difficult to source control. If you would like to make a contribution to `mote-hardware` please announce your intention and timeline via [the issue tracker](https://github.com/empriselab/mote-core/issues).
