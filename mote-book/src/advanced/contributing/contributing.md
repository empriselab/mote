...
First-time contributors should read through the documentation, then check out the [open issues](https://github.com/empriselab/mote-core/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22).
